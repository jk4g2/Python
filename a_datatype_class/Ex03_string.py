...
print(day[0:4]+ "년 " + day[5:7] + "월 " + day[8:10] + "일" +    "\n"     + day[-8:-6] + "시 " + day[-5:-3] + "분")
...
#       s.index('글') : s 문자열에서 문자 '글' 위치 알려주기 find와 동일하나 존재하지않는 문자를 넣으면 에러발생
#       s.find('글') : s 문자열에서 문자 '글' 위치 알려주기 존재하지 않는 문자를 넣으면 -1출력
...
print(msg.replace("우","오")) #오리는 독도를 지킨다
print(msg.split()) #['우리는', '독도를', '지킨다']
print(msg.split("독도를")) #['우리는 ', ' 지킨다']
print(",".join(msg.split())) #우리는,독도를,지킨다
